    ...
    <div className="">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {colloading ? <div className="text-white text-xl">Loading...</div> : collections.length > 0 ? collections.map((collection) => (
          <div className="">
            ...
            >
              ...
              >
                ...
                {
                  open[collection._id] ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
          ...
          <div className="dark:text-[#e2e2e2] text-black w-full lg:text-3xl md:text-2xl text-xl text-center font-normal md:pt-6 font-['Inter']">No collections found</div>
        )}
      </div>
    </div>
  );
