                                        ...
                                        .map((ledger) => (
                                            ...
                                            >
                                                ...
                                                <div className="ml-4 w-full flex flex-wrap justify-between items-center">
                                                    {/* Transaction Type */}
                                                    <p className="font-semibold text-lg text-gray-800 dark:text-white text-center">
                                                        {transactionTypeDisplay[ledger.transactionType] || ledger.transactionType}
                                                    </p>

                                                    {/* Amount */}
                                                    <p className={`text-xl text-center font-bold pb-2 flex items-center ${ledger.transactionType === "debit" ? "text-red-500 dark:text-red-400" :
