      ...
      <div className="shadow-lg rounded-xl p-8 max-w-md w-full bg-lightSecondary dark:bg-darkSecondary dark:text-white">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            ...
            className="w-full bg-gray-300 text-black py-2 rounded-xl uppercase hover:opacity-95 disabled:opacity-80 mb-4"
          >
            Resend OTP
          </button>
          ...
          <button
            type="submit"
            className="w-full bg-teal-800 text-black py-3 rounded-xl uppercase hover:opacity-95 disabled:opacity-80"
          >
            Reset
          </button>
        </form>
