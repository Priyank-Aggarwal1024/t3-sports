      ...
      {homeLoading ? (
        ...
        <div className="min-h-screen bg-gray-100 dark:bg-black">
            ...
            <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-6">
              <div className="lg:px-8 md:py-6 md:px-6 p-4 cursor-pointer rounded-[20px] dark:bg-[#121212] bg-gray-300 shadow-md shadow-black dark:hover:bg-[#2F60F3] hover:bg-[#2F60F3] group">
                <div className="flex justify-between items-center">
                  <div className="dark:text-[#e2e2e2] text-black lg:text-xl text-lg font-medium font-['Inter']">
                    Today’s Orders
                  </div>
                  <div className="lg:w-12 lg:h-12 md:h-10 md:w-10 w-8 h-8 rounded-full bg-[#2F60F3] group-hover:bg-black flex justify-center items-center">
                    ...
                    >
                      <path
                        d="M25.8892 8.89178V21.8918C25.8892 22.157 25.7838 22.4114 25.5963 22.5989C25.4087 22.7864 25.1544 22.8918 24.8892 22.8918C24.624 22.8918 24.3696 22.7864 24.1821 22.5989C23.9945 22.4114 23.8892 22.157 23.8892 21.8918V11.3055L9.59667 25.5993C9.40903 25.7869 9.15453 25.8923 8.88917 25.8923C8.6238 25.8923 8.36931 25.7869 8.18167 25.5993C7.99403 25.4116 7.88861 25.1571 7.88861 24.8918C7.88861 24.6264 7.99403 24.3719 8.18167 24.1843L22.4754 9.89178H11.8892C11.624 9.89178 11.3696 9.78643 11.1821 9.59889C10.9945 9.41135 10.8892 9.157 10.8892 8.89178C10.8892 8.62657 10.9945 8.37221 11.1821 8.18468C11.3696 7.99714 11.624 7.89178 11.8892 7.89178H24.8892C25.1544 7.89178 25.4087 7.99714 25.5963 8.18468C25.7838 8.37221 25.8892 8.62657 25.8892 8.89178Z"
                        fill="white"
                      />
                    </svg>
                    <svg
                ...
                <div className="pt-6 w-full">
                  <div className="dark:text-[#e2e2e2] text-black xl:text-5xl lg:text-4xl text-3xl font-medium font-['Inter']">
                    {Number(todayOrders).toLocaleString()}
                  </div>
                  <div className="dark:text-[#e2e2e2] text-black pt-2.5 lg:text-[17px] text-[14px] font-normal font-['Inter']">
                    New orders
                  </div>
                </div>
              </div>
              ...
              <div className="lg:px-8 md:py-6 md:px-6 p-4 cursor-pointer rounded-[20px] dark:bg-[#121212] bg-gray-300 shadow-md shadow-black dark:hover:bg-[#2F60F3] hover:bg-[#2F60F3] group">
                ...
                <div className="pt-6 w-full">
                  <div className="dark:text-[#e2e2e2] text-black xl:text-5xl lg:text-4xl text-3xl font-medium font-['Inter']">
                    ₹ {Number(aov.toFixed(2)).toLocaleString()}
                  </div>
                  <div className="dark:text-[#e2e2e2] text-black pt-2.5 lg:text-[17px] text-[14px] font-normal font-['Inter']">
                    This week
                  </div>
          ...
          <div className="w-full lg:px-16 md:px-8 px-4 py-10">
            ...
            <div className="bg-white dark:bg-darkPrimary rounded-md shadow-md sm:p-6 p-4">
              ...
              <div className="block w-full overflow-x-auto max-h-screen overflow-y-auto">
                {fproducts.length === 0 ? (
                  <p className="text-center text-black dark:text-white">
                    No Products found.
                  </p>
                ) : (
                  <table className="items-center bg-transparent w-full min-w-[1050px] border-collapse">
                    <thead>
                      <tr>
