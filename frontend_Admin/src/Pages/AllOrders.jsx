    ...
    <div className="p-6 dark:bg-black bg-white">
      <div className="flex justify-between items-center lg:flex-row flex-col gap-6 my-6">
        <div className="w-full flex justify-between xs:items-center xs:gap-6 gap-4 xs:flex-row flex-col">
          <h2 className="text-lg md:text-2xl w-full lg:text-3xl font-bold text-black dark:text-white">
            Order List
          </h2>
          <select
            id={"filter-by"}
            ...
            {filterBy === "date" ? (
              <div className="dark:text-white md:flex-row flex-col items-start flex md:items-center gap-4">
                <div className="flex w-full items-center justify-between gap-4">
                  <label htmlFor="fromDate" className="text-lg">
                    From:
                  </label>
                  <input
                    type="date"
                ...
                <div className="flex w-full items-center justify-between gap-4">
                  <label htmlFor="toDate" className="text-lg">
                    To:
                  </label>
                  <input
                    type="date"
        ...
        <table className="min-w-full bg-white dark:bg-black dark:text-white border border-gray-800">
          <thead className="dark:bg-darkPrimary">
            <tr className="text-sm text-left">
              <th className="py-2 px-4 border border-gray-600 whitespace-nowrap">
                Serial No.
              </th>
              ...
              <th className="py-2 px-4 border border-gray-600">Action</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={index} className="text-sm">
                ...
                <td className="py-2 px-4 border border-gray-600">
                  {updateOrderId !== order._id ? (
                    <span
                      className={`py-1 rounded-full px-3 text-xs ${
      ...
      <div className="w-full flex justify-end">
        <button
          onClick={() =>
            exportToExcel(filterAndTransformOrders(), "orders-excel")
          }
