            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-h-screen overflow-y-auto">
              {warehouses.map((warehouse, wid) => (
                <div className="" key={wid}>
                  <div
                    key={warehouse._id}
                    className="bg-white dark:bg-darkPrimary shadow-lg rounded-md md:p-9 sm:p-6 py-4 px-3 transition-transform transform w-full flex flex-col md:gap-9 gap-5"
                  >
                    <div
...
WarehouseCard.propTypes = {
  upq: PropTypes.any.isRequired,
  setUpq: PropTypes.func.isRequired,
};
