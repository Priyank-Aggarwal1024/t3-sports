...
const OrderSummary = ({ products, shippingDetails }) => {
      ...
      <div className="flex flex-col w-full items-end lg:pt-12 md:pt-8 pt-6">
        <div className="grid md:grid-cols-2 md:gap-5 gap-3 w-full">
          ...
          <div className="grid grid-cols-3 w-full">
            <div className=""></div>
            <div className="text-left dark:text-white text-black lg:text-2xl md:text-xl text-lg font-normal font-['Inter']">
              Total Price:
            </div>
            <div className="dark:text-white text-right text-black font-semibold lg:text-2xl md:text-xl text-lg font-['Inter']">
          ...
          <div className="w-full grid grid-cols-2">
            <div className="dark:text-white text-black lg:text-3xl text-left md:text-2xl text-xl font-normal font-['Inter']">
              Amount Payable:
            </div>
            <div className="dark:text-white text-right text-black  text-3xl font-semibold font-['Inter']">
              ₹ {totalPrice + shippingPrice + codPrice}
            </div>
          </div>
        </div>
      </div>
...
OrderSummary.propTypes = {
  ...
  shippingDetails: PropTypes.shape({
    ...
    codCharges: PropTypes.number.isRequired,
  }).isRequired,
};
